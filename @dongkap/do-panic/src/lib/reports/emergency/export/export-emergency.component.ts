...
@Component({
  selector: 'xa-export-emergency',
  templateUrl: 'export-emergency.component.html',
  styleUrls: ['export-emergency.component.scss'],
})
export class ExportEmergencyComponent {
  ...
  constructor(protected ref: NbDialogRef<ExportEmergencyComponent>) {
  }
